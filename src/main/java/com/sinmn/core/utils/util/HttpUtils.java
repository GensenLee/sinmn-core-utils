...
import com.sinmn.core.utils.vo.HttpResVO;
...
//			response = method.getResponseBodyAsString();
	 ...
	 * @description 获取文件流 
	 * @author xhz
	 * @date 2017年8月7日 上午10:46:34
	 * @return
	 * @lastModifier
	 */
	public static InputStream doGetForInputStream(String url){
...
//		managerParams.setSoTimeout(15000);
		...
		try {
	        ...
	        ByteArrayInputStream resultStream = new ByteArrayInputStream(swapStream.toByteArray());
	        swapStream.close();
...
//			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
	 ...
	 * @return
	 */
	public static String doPostStream(String url, Object param) {
		String strParam = "{}";
		
		if (param != null) {
			strParam = FastJsonUtils.toJsonString(param);
		}
		StringBuilder sb = new StringBuilder();
		BufferedReader in = null;
		try {
			logger.info("post data :" + strParam);
			URL postURL = new URL(url);
			HttpURLConnection con = (HttpURLConnection) postURL.openConnection();
			...
			out.print(strParam); // send to server
	...
	public static void main(String[] args) throws HttpException, IOException {
		System.out.println(upload("http://localhost:10000/api/file/uploadFileByPath.do","a.txt","test".getBytes()));
